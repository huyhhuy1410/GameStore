    ...
    <div class="container-fluid">
        ...
        if (isset($_POST['txtidsubject'])) {
            ...
            if ($images != "" ) 
                ...
                $sql    = "update tblgame set id_subject=$id_subject, name_game='$name_game', price=$price, status='$status', ver='$ver', region='$region', active= '$active', des='$des' where id_game=$id_game";
             ...
             if ($videos != "") 
             $sql    = "update tblgame set id_subject=$id_subject,  name_game='$name_game', price=$price, status='$status', ver='$ver', region='$region', active= '$active', images='$images', videos='$videos', des='$des' where id_game=$id_game";
             else                 $sql    = "update tblgame set id_subject=$id_subject, name_game='$name_game', price=$price, status='$status', ver='$ver', region='$region', active= '$active', des='$des' where id_game=$id_game";
